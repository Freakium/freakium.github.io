!function(){let e=new bootstrap.Offcanvas("#itemForm"),t=4,a=flatpickr(".datepicker",{enableTime:!0,dateFormat:"Y-m-d H:i",altInput:!0,altFormat:"Y-m-d, h:i K"});function n(e){let t=0;e.forEach(e=>{let a=e.weight?d(e.price,e.weight):e.price;l(e.id,e.name,e.type,e.colour,e.quantity,e.date,a);let n=parseFloat(e.price),i=parseInt(e.quantity);isNaN(n)||(t+=n*i)}),o(),c(t)}function l(e,t,a,n,l,i,r){let d=new Date(i),s=d.toLocaleString("en-US",{dateStyle:"long",timeStyle:"short"}),m=g(r??0);document.getElementById("item-list").innerHTML+=`<div class="col" id="${e}">
        <div class="card shadow h-100">
          ...
          <div class="card-footer">
            <small class="text-body-secondary" id="${e}-itemDate" title="Appointment Date">${s}</small>
          </div>
        </div>
      </div>`}function i(e){let t=0;document.querySelectorAll(".badge-price").forEach(e=>{let a=parseFloat(e.getAttribute("data-price")),n=parseInt(e.getAttribute("data-quantity"));isNaN(a)||(t+=a*n)}),e&&(t+=e),c(t)}function r(e=!1){!function e(t=!1){let a=api.fetchItems();if(!a&&t){s("messageArea","A problem occurred while loading file. Please make sure you are loading the correct inventory file.","danger",3);return}n(a)}(e);let t;t=api.fetchTitle()??"Inventory",document.getElementById("inventoryTitle").value=t;let a;a=api.fetchCurrency()??"$",document.getElementById("currencySymbolSelect").value=a,u(a)}function d(e,t){return(e*t).toFixed(2)}function s(e,t,a,n){if("string"!=typeof t||"string"!=typeof e||0==e.length)return;if(0===t.length){document.getElementById(e).innerHTML="<br>";return}let l=`<div class="alert alert-${a} alert-dismissible fade show d-flex shadow py-2" role="alert">
